...
export default function AboutUsCard({ developer }) {
  ...
  const handleNextSlide = () => {
    setSlideIndex((prevIndex) => prevIndex === maxIndex ? prevIndex : prevIndex + 1);
  };

  const handlePreviousSlide = () => {
    setSlideIndex((prevIndex) => prevIndex === minIndex ? prevIndex : prevIndex - 1);
  };
  ...
  return (
    <Container sx={{ padding: "5px", width: "310px" }} disableGutters maxWidth={false}>
      <Card
      ...
      >
        ...
        >
          <CardContent sx={{ flex: "1 0 auto", width: "117px", height: "80px" }}>
      ...
      >
        ...
        {slideIndex === 2 &&
            <Box sx={{direction: "column", alignItems: "center", justifyContent: "center"}}>
              <Link href="#" to={developer.linkedin} style={{color: "white"}} onClick={handleLinkClick}>
                Learn more about me
              </Link>
            </Box>
        }
